...
extern const MIDL_SERVER_INFO WallOfText_ServerInfo;

extern const RPC_DISPATCH_TABLE WallOfText_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE WallOfText___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x3e64c978,0xf038,0x46f0,{0xbb,0x41,0x12,0x50,0xef,0xab,0x6b,0xc5}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&WallOfText_v1_0_DispatchTable,
    0,
    0,
    0,
    &WallOfText_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE WallOfText_v1_0_s_ifspec = (RPC_IF_HANDLE)& WallOfText___RpcServerInterface;
...
static const MIDL_STUB_DESC WallOfText_StubDesc = 
    {
    (void *)& WallOfText___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION WallOfText_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE WallOfText_v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)WallOfText_table
    };

static const SERVER_ROUTINE WallOfText_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)ping,
    (SERVER_ROUTINE)addMessage,
    (SERVER_ROUTINE)getMessage,
    (SERVER_ROUTINE)getLastMessages
    };

static const MIDL_SERVER_INFO WallOfText_ServerInfo = 
    {
    &WallOfText_StubDesc,
    WallOfText_ServerRoutineTable,
    WallOfText__MIDL_ProcFormatString.Format,
    WallOfText_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
